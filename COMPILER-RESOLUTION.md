...
### CODEGEN-1 — Generic post-extract symbol synthesis  ·  [hook]  ·  ⚠️ (seam + Java Lombok + Kotlin data class done; generic method-return element typing done for colon/arrow `3a8491df` AND leading-form Java/C# `a18c704d`)
