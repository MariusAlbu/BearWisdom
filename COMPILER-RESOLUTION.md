...
### CODEGEN-1 — Generic post-extract symbol synthesis  ·  [hook]  ·  ⚠️ (seam + Java Lombok + Kotlin data class done; generic method-return element typing done for colon/arrow-form langs, `3a8491df`)
