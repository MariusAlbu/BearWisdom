...
pub(crate) fn build_nuget_source_symbol_index(dep_roots: &[ExternalDepRoot]) -> SymbolLocationIndex {
...
pub(crate) fn resolve_nuget_source_symbols(dep: &ExternalDepRoot, symbols: &[&str]) -> Vec<WalkedFile> {
