...
//   Variable  — Dim / Public / Private / Protected at module scope
//
// REFERENCES:
...
//   - Continuation: " _" at end of line — handled by ignoring the underscore token.
// =============================================================================
...
pub fn extract(source: &str) -> ExtractionResult {
    ...
    // Nesting depth for nested If/For/With blocks (not subs — VBA doesn't nest subs).
    ...
    for (lineno, raw_line) in source.lines().enumerate() {
        ...
        // Call statements inside proc bodies.
        if in_proc {
