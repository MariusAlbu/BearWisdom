// =============================================================================
// swift/type_checker.rs — Swift type checker
//
// Swift has generics but no wildcard-import namespace lookup. Chain walking
// is the unified `crate::type_checker::chain::resolve_via_chain` with the
// Swift config.
// =============================================================================
...
impl TypeChecker for SwiftChecker {
