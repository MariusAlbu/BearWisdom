...
pub(crate) const KEYWORDS: &[&str] = &[
    ...
    // Wider DevOps / sysadmin / archive / package tooling that surfaces
    // in any serious shell-init / dotfiles repo (oh-my-bash, bash-it,
    // chezmoi-driven configs).
    "cap", "fab", "salt", "salt-call", "salt-key", "salt-run",
    "vault", "consul", "nomad",
    "drush", "wp", "artisan", "magento",
    "fasd", "z", "j", "autojump", "zoxide",
    "rvm-prompt",
    "kitchen", "vagrant-box",
    "ansible-galaxy", "ansible-vault",
    "chruby", "chruby_auto", "rbenv-rehash", "goenv", "jenv", "tfenv",
    "dotnet", "msbuild", "nuget",
    "WMIC", "wmic", "powershell", "pwsh",
    "scutil", "defaults", "ioreg", "pmset", "acpi", "upower",
    "dircolors", "lesspipe", "lesspipe.sh", "scselect",
    "notify-send", "zenity", "yad",
    "7z", "7za", "unrar", "bunzip2", "uncompress", "mkisofs",
    "column", "shuf", "getopt", "xterm", "kitty", "alacritty", "wezterm",
    "zellij", "byobu",
    "view", "vimdiff", "ex", "ed",
    "m4",
];
