// =============================================================================
// ruby/type_checker.rs — Ruby type checker
//
// Walks `MemberChain` step-by-step using a Ruby-specific algorithm. Was
// `languages/ruby/chain.rs` (free function `resolve_via_chain`); ported
// onto the `TypeChecker` trait per decision-2026-04-27-e75.
// =============================================================================
...
impl TypeChecker for RubyChecker {
