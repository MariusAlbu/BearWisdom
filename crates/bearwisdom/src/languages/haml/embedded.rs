...
mod tests {
    ...
    fn eq_becomes_ruby() {
        ...
        assert!(regions
            .iter()
            .any(|r| r.language_id == "ruby" && r.text.contains("@user")));
    }
    ...
    fn js_filter_captures_block() {
        ...
        assert!(regions
            .iter()
            .any(|r| r.language_id == "javascript" && r.text.contains("console.log")));
    }
    ...
    fn hash_interpolation_becomes_ruby() {
        ...
        assert!(regions
            .iter()
            .any(|r| r.language_id == "ruby" && r.text.contains("@user.name")));
    }
}
