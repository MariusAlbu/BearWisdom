...
/// Rust cargo registry → `~/.cargo/registry/src/<index>/<crate>-<ver>/`.
...
// ===========================================================================
// SCALA / SBT — sbt dependency discovery via Maven source jars
// ===========================================================================
...
// ===========================================================================
// RUST / CARGO — registry source discovery
// ===========================================================================
...
fn find_first_subdir(dir: &Path) -> Option<PathBuf> {
