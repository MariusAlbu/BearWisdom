...
declare module Foo {\n\
  interface NotAnAugmentation {}\n\
    ...
    let got = super::scan_module_augmentations(src);
...
fn interface_name_strips_generics_and_keyword() {
    assert_eq!(super::interface_name("interface Assertion<T = any>"), Some("Assertion"));
    assert_eq!(super::interface_name("export interface Foo {"), Some("Foo"));
    assert_eq!(super::interface_name("  not an interface line"), None);
}
