...
fn same_name_property_and_method_select_the_method_for_a_call() {
    ...
    let lookup = Lookup::new()
        .with_member_id(
            1,
            sym(71, "messages", "Validator.messages", "property", "v.php"),
        )
        .with_member_id(
            1,
            sym(72, "messages", "Validator.messages", "method", "v.php"),
        );
    ...
    assert_eq!(
        select_typed(&lookup, &arena, recv, name, &calls),
        Selection::Unique(72)
    );
...
fn kind_rejected_child_member_does_not_hide_an_admitted_trait_member() {
    ...
    let lookup = Lookup::new()
        ...
        .with_member_id(
            2,
            sym(72, "factory", "HasFactory.factory", "method", "t.php"),
        );
