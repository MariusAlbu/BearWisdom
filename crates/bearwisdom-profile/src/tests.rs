...
mod detection {
    ...
    #[test]
    fn rbs_extension_is_discovered_with_ruby_sources() {
        let lang = detect_language(Path::new("catalog.rbs")).expect("should detect");
        assert_eq!(lang.id, "ruby");
    }
...
mod registry_tests {
    ...
    #[test]
    fn languages_count() {
        assert_eq!(LANGUAGES.len(), 101, "expected 101 language descriptors");
    }
